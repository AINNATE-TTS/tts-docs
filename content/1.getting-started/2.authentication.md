...
The Text To Speech Ainnate (TTS) API uses API keys to authenticate requests. You can create and manage your API keys in the [Service Intergration](https://ttsopenai.com/profile/integration/api-keys).
