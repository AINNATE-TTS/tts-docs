...
The Text To Speech Ainnate (TTS) API allows you to convert text into high-quality, natural-sounding speech. You can use this API to generate voiceovers for multimedia content, create narrations for e-books and documents, or turn subtitles into engaging audio experiences.
...
curl -X POST https://api.ttsopenai.com/uapi/v1/text-to-speech \
  ...
  -d '{
    ...
    "voice_id": "OA001",
    "speed": 1,
    "input": "Hello, my name is Ainnate. I am a text-to-speech model."
  }'
```
...
```json [Response]
{
  ...
  "result": {
    ...
    "speed": 1,
    "model": "tts-1",
    "tts_input": "Hello, my name is Ainnate. I am a text-to-speech model.",
    "estimated_credit": 54,
    "used_credit": 54,
    "status": 1,
